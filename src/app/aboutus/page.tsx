...
function Check ({ children }: { children: React.ReactNode }) {
    return (
        <span className="flex w-full text-sm items-start space-x-2 ml-10"><FaCheck /><p className="font-bold md:font-normal font-sans">{ children }</p></span>
    )
}
...
function ContentContainer ({ children }: { children: React.ReactNode }) {
    return (
        <span className="flex flex-col md:flex-row items-center md:items-start md:space-x-10 space-y-5 md:space-y-10">{ children }</span>
    )
}

function PointContainer ({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex flex-col md:w-1/2">{ children }</div>
    )
}
...
function ContentPoint ({ children }: { children: React.ReactNode }) {
    return (
        <p className="text-sm font-sans mt-2">{ children }</p>
    )
}
