                            ...
                            { clubsData && clubsData.content.map((club, index) => (
                                <DashboardContainer key={index} className="flex flex-col md:flex-row md:h-36 cursor-pointer" clubId={club.id}>
                                    ...
                                    <div className="flex flex-col justify-center w-full p-4">
                                        ...
                                        <p className="text-xs font-sans mb-2 text-wrap min-h-12 md:h-fit">{ club.description }</p>
                                        <div className="hidden md:flex flex-col justify-end space-y-1 h-full">
                                            <p className="text-sm text-mainOrange text-wrap">{ club.location.name }</p>
                                    ...
                                    <span className="flex justify-end items-center p-4">
                                        <div className="flex md:hidden flex-col justify-end space-y-1 h-full w-full">
                                            <p className="text-xs 2xs:text-sm text-mainOrange">{ club.location.name }</p>
