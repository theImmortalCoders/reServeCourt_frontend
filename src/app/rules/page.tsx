function Point ({ children }: { children: React.ReactNode }) {
    return (
        <h1 className="text-xl md:text-2xl text-mainOrange pt-2">{ children }</h1>
    )
}
...
export default function Page() {
    return (
        <div className="flex flex-col items-center min-h-max">
            <div className="m-8 p-5 w-3/4 h-auto border-2 border-darkGreen rounded-2xl space-y-2">
                ...
                <Point>I. Postanowienia ogólne</Point>
                <List>
                ...
                <Point>II. Rezerwacja kortu</Point>
                <List>
                ...
                <Point>III. Opłaty i płatności</Point>
                <List>
                ...
                <Point>IV. Odwołanie Rezerwacji</Point>
                <List>
                    <Rule>
                ...
                <Point>V. Zasady korzystania z kortu</Point>
                <List>
                ...
                <Point>VI. Postanowienia końcowe</Point>
                <List>
